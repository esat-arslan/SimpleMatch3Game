...
public sealed class Board : MonoBehaviour
{
    ...
    private bool AreNeighbours(Tile tile1, Tile tile2)
    {
        if (tile1.x == tile2.x && Mathf.Abs(tile1.y - tile2.y) == 1) return true;

        if (tile1.y == tile2.y && Mathf.Abs(tile1.x - tile2.x) == 1) return true;
